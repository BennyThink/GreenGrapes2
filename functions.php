...
'));
    ...
    $TwitterURL = new Typecho_Widget_Helper_Form_Element_Text('TwitterURL', null, null, _t('Twitter 地址，如https://twitter.com/BennyThinks，留空则不显示,下同'), null);
    ...
    $TelegramURL = new Typecho_Widget_Helper_Form_Element_Text('TelegramURL', null, null, _t('Telegram 用户名，如BennyThink，不需要带@'), null);
    $form->addInput($TelegramURL);
    $QQURL = new Typecho_Widget_Helper_Form_Element_Text('QQURL', null, null, _t('QQ号'), null);
    $form->addInput($QQURL);
    $weixin = new Typecho_Widget_Helper_Form_Element_Text('weixin', null, null, _t('微信个人号，需要二维码名片的图片链接'), null);
    $form->addInput($weixin);
    $weixinSAURL = new Typecho_Widget_Helper_Form_Element_Text('weixinSAURL', null, null, _t('微信公众号（暂只支持公众号，直接填写微信号即可）'), null);
...
function threadedComments($comments, $options)
{
    ...
    ?>">
        ...
        <div class="comment-author" itemprop="creator" itemscope itemtype="http://schema.org/Person">
            <span itemprop="image"><?php $imgurl = avatar($comments->mail);
                echo $imgurl; ?></span>
        </div>
        <div class="comment-body">
            ...
            <div class="comment-footer">
                <time itemprop="commentTime"
                      datetime="<?php $comments->date('c'); ?>"><?php $singleCommentOptions->beforeDate();
