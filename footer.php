<div id="back-to-top" class="red" title="返回顶部" data-scroll="body" style="display: none;">
    <svg id="point-up" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" width="32"
...
<footer id="m-footer">
    ...
    <?php if ($this->options->SNSPos != 'showSideBar'): ?>
        ...
        <?php if (!empty($this->options->FacebookURL)) : ?><span class="fa-stack fa-lg">
            <a class="fa fa-facebook fa-stack-1x" href="<?php $this->options->FacebookURL() ?>"
               target="view_window"></a>
            </span><?php endif; ?>
        <?php if (!empty($this->options->GooglePlusURL)) : ?><span class="fa-stack fa-lg">
            <a class="fa fa-google-plus fa-stack-1x" href="<?php $this->options->GooglePlusURL() ?>"
               target="view_window"></a>
            </span><?php endif; ?>
        ...
        <?php if (!empty($this->options->InstagramURL)) : ?><span class="fa-stack fa-lg">
            <a class="fa fa-instagram fa-stack-1x" href="<?php $this->options->InstagramURL() ?>"
               target="view_window"></a>
            </span><?php endif; ?>
        ...
        <?php if (!empty($this->options->TelegramURL)) : ?><span class="fa-stack fa-lg">
            <a class="fa fa-telegram fa-stack-1x" href="<?php echo 'https://t.me/' . $this->options->TelegramURL ?>"
               target="view_window"></a>
            </span><?php endif; ?>
        <?php if (!empty($this->options->QQURL)) : ?><span class="fa-stack fa-lg">
            <a class="fa fa-qq fa-stack-1x"
               href="http://wpa.qq.com/msgrd?v=3&uin=<?php $this->options->QQURL() ?>&site=qq&menu=yes"
               target="view_window"></a>
            </span><?php endif; ?>

        <?php if (!empty($this->options->weixin)) : ?><span class="fa-stack fa-lg">
            <a class="fa fa-weixin fa-stack-1x" href="<?php echo $this->options->weixin ?>" target="view_window"></a>
            </span><?php endif; ?>
        <?php if (!empty($this->options->weixinSAURL)) : ?><span class="fa-stack fa-lg">
            <a class="fa fa-weixin fa-stack-1x"
               href="https://open.weixin.qq.com/qr/code?username=<?php echo $this->options->weixinSAURL ?>"
               target="view_window"></a>
            </span><?php endif; ?>
    <?php endif; ?>
</footer>
